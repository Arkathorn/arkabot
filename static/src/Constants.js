const ARKABOT_URL = 'https://arkabot.solutions';

export default {
  DISCORD_URL: 'https://discordapp.com?utm_source=arkabotsubtext&utm_medium=website&utm_campaign=arkabot',
  GITHUB_URL: 'https://github.com/hammerandchisel/arkabotbot',
  ARKABOT_URL,
  ...
  Image: {
    ARKABOT_COUNTER: require('./images/arkabot-counter.svg'),
    ...
    ISLAND_ARKABOT_MOBILE: require('./images/island-arkabot-mobile.svg'),
  ...
  Video: {
    ARKABOT: require('./videos/arkabot.mp4'),
    ARKABOT_WEBM: require('./videos/arkabot.webm')
  },

  Audio: {
    ARKABOT: require('../../audio/arkabot_default.wav')
  },
